...
public class CartController : Controller
{
    ...
    public CartController(BellyBoxContext context)
    {
        _context = context;
    }
    ...
    public async Task<ActionResult<Cart>> Create()
    {
        ...
        return CreatedAtAction("Get", new { ownerId = newCart.OwnerId }, newCart);
    }
    ...
    public async Task<IActionResult> AddToCart(int id, CartRequestData request)
    {
        ...
        return CreatedAtAction("Get", cartItem?.ToCartItem());
