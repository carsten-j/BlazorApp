...
namespace BellyBox.Server.Data
{
    public static class DatabaseSeed
    {
        ...
        public static CartData GenerateCarts(BellyBoxContext context)
        {
            CartData demoCart = new();
            demoCart.Items.Add(new CartItemData
            {
                Meal = context.Meals.First(),
                Quantity = 5,
            });
            demoCart.Items.Add(new CartItemData
            {
                Meal = context.Meals.First(m=>m.MealId == 6),
                Quantity = 2,
            });
            return demoCart;
        }
     ...
     .Options;
            ...
            //    {
            //        context.Carts.AddRange(GenerateCarts(context));
            //        context.SaveChanges();
            //    }
            //}
        }
